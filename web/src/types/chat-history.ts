...
export interface AdminChatMessageProductSnapshot {
  id: string;
  name: string | null;
  name_ar?: string | null;
  name_en?: string | null;
...
export interface AdminChatMessage {
  ...
  product_snapshots: AdminChatMessageProductSnapshot[];
  search_context: {
...
export type ChatProduct = AdminChatMessageProductSnapshot;
